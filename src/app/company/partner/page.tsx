  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#0d0d0d" }}>
      ...
      <main className="flex-1 flex flex-col">
        ...
        `}</style>
        <section id="partners" className="relative px-[16px] md:px-[40px] py-[70px] overflow-hidden" style={{ background: "#fff", borderTop: "1px solid #e8e8e8" }}>
        ...
        <section className="relative px-[16px] md:px-[40px] py-[70px] overflow-hidden" style={{ background: "#0d0d0d", borderTop: "1px solid #1a1a1a" }}>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" style={{ position: "absolute", inset: 0, opacity: 0.18 }}>
              <defs>
                <pattern id="tracks-grid" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#ef5023" strokeWidth="0.5"/>
                </pattern>
              </defs>
          ...
          <div className="relative max-w-[1320px] mx-auto flex flex-col gap-[48px]" style={{ zIndex: 1 }}>
            ...
            {/* Table: 2 columns + orange divider */}
            <div className="flex flex-col lg:flex-row">

              {/* IGA column */}
              <div className="flex flex-col gap-[24px] flex-1 lg:pr-[48px]">
                <div className="flex flex-col gap-[6px]">
                  <div className="flex items-center gap-[10px]">
                    <h3 className="font-black text-white text-[20px] leading-[1.2]">InApps Growth Alliance</h3>
                    <span className="text-[11px] font-black px-[8px] py-[3px] rounded-full" style={{ background: "rgba(239,80,35,0.15)", color: "#ef5023" }}>IGA</span>
                  </div>
                  <p className="text-[13px]" style={{ color: "#555" }}>Growth Partner · EU · US · AU · SG</p>
                </div>

                <p className="text-[14px] leading-[1.8]" style={{ color: "#888" }}>
                  Co-sell and co-deliver software projects with InApps. Earn tiered commissions on deals you bring or close together, with full deal protection.
                </p>

                <div className="flex flex-col gap-[12px]">
                  {[
                    { text: "Tiered commissions up to 20%", bold: true },
                    { text: "Deal registration & exclusivity" },
                    { text: "Co-selling support & playbooks" },
                    { text: "BOT / ODC setup pathways" },
                  ].map((item) => (
                    <div key={item.text} className="flex items-center gap-[10px]">
                      ...
                      <span className="text-[13px]" style={{ color: item.bold ? "#fff" : "#aaa", fontWeight: item.bold ? 700 : 400 }}>{item.text}</span>
                    </div>
                  ))}
                </div>
              ...
              {/* Orange divider */}
              <div className="hidden lg:block flex-shrink-0" style={{ width: "2px", background: "#ef5023", borderRadius: "2px" }} />
              <div className="lg:hidden" style={{ height: "2px", background: "#ef5023", borderRadius: "2px", margin: "32px 0" }} />

              {/* TPN column */}
              <div className="flex flex-col gap-[24px] flex-1 lg:pl-[48px]">
                <div className="flex flex-col gap-[6px]">
                  <div className="flex items-center gap-[10px]">
                    <h3 className="font-black text-white text-[20px] leading-[1.2]">InApps Talent Partner Network</h3>
                    <span className="text-[11px] font-black px-[8px] py-[3px] rounded-full" style={{ background: "rgba(239,80,35,0.15)", color: "#ef5023" }}>TPN</span>
                  </div>
                  <p className="text-[13px]" style={{ color: "#555" }}>Talent Partner · VN · PH</p>
                </div>

                <p className="text-[14px] leading-[1.8]" style={{ color: "#888" }}>
                  Supply pre-vetted engineers into InApps projects. Access a predictable, long-term demand pipeline for your team across 10+ tech stacks.
                </p>

                <div className="flex flex-col gap-[12px]">
                  {[
                    { text: "Predictable, long-term demand pipeline", bold: true },
                    { text: "Clear SLAs & feedback loops" },
                    { text: "Preferred supplier program" },
                    { text: "Premium rate negotiations" },
                  ].map((item) => (
                    <div key={item.text} className="flex items-center gap-[10px]">
                      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
                        <circle cx="10" cy="10" r="9" stroke="#ef5023" strokeWidth="1.5"/>
            ...
            {(() => {
              ...
              return (
                <div className="flex flex-col gap-[40px]">
                  ...
                  {/* ── Progression diagram ── */}
                  <div className="flex flex-col md:flex-row items-center justify-center md:gap-[48px] gap-[8px]">
                    {tiers.map((tier, i) => (
                        ...
                        {i < tiers.length - 1 && (
                          <div className="md:hidden" style={{ flexShrink: 0 }}>
                            <svg width="20" height="24" viewBox="0 0 20 24" fill="none">
                              <line x1="10" y1="2" x2="10" y2="16" stroke="#ef5023" strokeWidth="1.5" strokeDasharray="4 3" strokeOpacity="0.6"/>
                              <path d="M3 13 L10 21 L17 13 Z" fill="rgba(239,80,35,0.15)" stroke="#ef5023" strokeWidth="1.2" strokeOpacity="0.55" strokeLinejoin="round"/>
                            </svg>
                          </div>
                        )}
                      </Fragment>
        ...
        <section className="relative px-[16px] md:px-[40px] py-[90px] overflow-hidden" style={{ background: "#0d0d0d" }}>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <svg style={{ position: "absolute", top: "18%", right: "12%", opacity: 0.13 }} width="18" height="18" viewBox="0 0 18 18" fill="none">
              <polygon points="9,1 17,17 1,17" stroke="#ef5023" strokeWidth="1.2" fill="none"/>
            </svg>
            <svg style={{ position: "absolute", top: "55%", right: "6%", opacity: 0.09, transform: "rotate(22deg)" }} width="12" height="12" viewBox="0 0 12 12" fill="none">
              <polygon points="6,1 11,11 1,11" stroke="#ef5023" strokeWidth="1" fill="rgba(239,80,35,0.15)"/>
            </svg>
            <svg style={{ position: "absolute", top: "30%", left: "8%", opacity: 0.10, transform: "rotate(-15deg)" }} width="14" height="14" viewBox="0 0 14 14" fill="none">
              <polygon points="7,1 13,13 1,13" stroke="#ef5023" strokeWidth="1" fill="none"/>
            </svg>
            <svg style={{ position: "absolute", bottom: "22%", left: "14%", opacity: 0.08, transform: "rotate(10deg)" }} width="10" height="10" viewBox="0 0 10 10" fill="none">
              <polygon points="5,1 9,9 1,9" stroke="#ef5023" strokeWidth="1" fill="rgba(239,80,35,0.2)"/>
            </svg>
            <svg style={{ position: "absolute", top: "12%", left: "38%", opacity: 0.07, transform: "rotate(30deg)" }} width="8" height="8" viewBox="0 0 8 8" fill="none">
              <polygon points="4,1 7,7 1,7" stroke="#ef5023" strokeWidth="1" fill="none"/>
            </svg>
          </div>

          <div className="relative max-w-[760px] mx-auto flex flex-col gap-[40px] items-center text-center" style={{ zIndex: 1 }}>

            {/* Heading */}
            <div className="flex flex-col gap-[12px]">
              <h2 className="font-black text-white leading-[1.05] whitespace-nowrap" style={{ fontSize: "clamp(22px, 4vw, 60px)", letterSpacing: "-2px" }}>
            ...
            {/* Two track rows */}
            <div className="flex flex-col w-full" style={{ borderRadius: "14px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.12)" }}>

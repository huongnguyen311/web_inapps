    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#0d0d0d" }}>
      ...
      <main className="flex-1">
        ...
        {service.slug === "ai-agent-development"
          ...
          : sections.buyerProblems.enabled && <ServiceBuyerProblems problems={sections.buyerProblems.problems} heading={sections.buyerProblems.heading} subtitle={sections.buyerProblems.subtitle} />
        }
        ...
        {service.slug !== "ai-agent-development" && sections.isRightForYou.enabled && <ServiceRightForYou checklist={sections.isRightForYou.checklist} />}
        {/* S5b - What's Included */}
        {service.slug !== "ai-agent-development" && sections.whatYouGet.enabled && <ServiceWhatYouGet items={sections.whatYouGet.items} />}
        {/* S7 - Timeline (ai-agent-development) or Process (other services) */}
        {service.slug === "ai-agent-development"
          ? <ServiceTimeline />
          : sections.process.enabled && <ServiceProcess steps={sections.process.steps} />
        }
        {/* S7b - Team Structure */}
        {sections.teamStructure.enabled && <ServiceTeamStructure roles={sections.teamStructure.roles} note={sections.teamStructure.note} />}
        {/* S7c - Quality & Vetting */}
        {sections.qualityVetting.enabled && <ServiceQualityVetting stages={sections.qualityVetting.stages} metrics={sections.qualityVetting.metrics} />}
        {/* S7d - Comparison */}
